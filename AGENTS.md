...
- Accent Yellow: `#FFF021` - accent lines, highlights
- Blue Primary: `#1C276C` - links, key sections
- Orange Secondary: `#FFB54F` - submit buttons, important actions
- Dark Navy: `#09090a` - main headings
- Gray Text: `#36454F` - supporting text, labels
